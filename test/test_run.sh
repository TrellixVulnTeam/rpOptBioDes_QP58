...
docker run -v ${PWD}/inside_run.sh:/home/inside_run.sh -v ${PWD}/tool_rpOptBioDes.py:/home/tool_rpOptBioDes.py -v ${PWD}/test_input.tar:/home/test_input.tar -v ${PWD}/results/:/home/results/ --rm brsynth/rpfba /bin/sh /home/inside_run.sh
